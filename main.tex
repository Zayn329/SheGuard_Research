...
\caption{End-to-end SheGuard system architecture, showing multimodal sensing, rule-based fusion, the incident state machine, offline communication pathways, cryptographic evidence vaulting, and isolated AI assistance.}
\label{fig:arch}
\end{figure}
